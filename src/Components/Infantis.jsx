      ...
      <div>
         ...
         <div className='fisrtSlider'>
            ...
            <div className='cards2'>
               ...
               <div className='imgedite'>
                  <img className=' rounded' src="img/aniversario 10.jpeg" width={300} height={400} alt='' />


               </div>

               <div className='imgedite'>
                  <img className=' rounded' src="img/aniver2.jpeg" width={300} height={400} alt='' />


               </div>

               <div className='imgedite'>
                  <img className='rounded' src="img/aniversarios1.jpeg" width={300} height={400} alt='' />

               </div>


               <div className='imgedite'>
                  <img className=' rounded' src="img/cenario noivos 3.jpeg" width={300} height={400} alt='' />
