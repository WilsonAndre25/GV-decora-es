            ...
            <div className='fisrtSlider'>
                ...
                < div className='cards'>
                    ...
                    <div className='imgedite'>
                        <img className='rounded' src="img/cenario rosa bal.jpeg" width={300} height={400} alt='' />
                        <div className='foote'>
                    ...
                    <div className='imgedite'>
                        <img className=' rounded' src="img/cenario gard.jpeg" width={300} height={400} alt='' />
                    ...
                    <div className='imgedite'>
                        <img className=' rounded' src="img/cenario aber verd.jpeg" width={300} height={400} alt='' />
                ...
                <div className='cards2'>
                    ...
                    <div className='imgedite'>
                        <img className=' rounded' src="img/anivers.jpeg" width={300} height={400} alt='' />


                    </div>

                    <div className='imgedite'>
                        <img className=' rounded' src="img/bolos.jpeg" width={300} height={400} alt='' />
